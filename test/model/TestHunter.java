...
public class TestHunter {
    ...
    public void test_get_hunter_know_empty_cases() {
        ...
        assertTrue(hunter.getKnowEmpty()[0][3]);// test si le chasseur a dans sa liste de case vide connus
                                                // la case 0,3
        // valide car le hunter a tiré ici et c'est une case vide

        // pas valide car le hunter a tiré ici et ce n'etait pas une case vide ou le
        // hunter n'a pas tiré ici
        assertFalse(hunter.getKnowEmpty()[0][0]);// test si le chasseur a dans sa liste de case vide connus
                                                 // la case 0,0
        assertFalse(hunter.getKnowEmpty()[2][1]);// test si le chasseur a dans sa liste de case vide connus
                                                 // la case 2,1
        assertFalse(hunter.getKnowEmpty()[1][3]);// test si le chasseur a dans sa liste de case vide connus
                                                 // la case 1,3
        // pas valide car le hunter a tiré ici et ce n'etait pas une case vide ou le
        // hunter n'a pas tiré ici
    }
    ...
    public void test_get_hunter_last_cord() {
        ...
        assertEquals(new Coordinate(2, 1), hunter.getHunterCoord());// test si le dernier tir du chasseur
                                                                    // est en 2,1
        // valide car c'est le dernier tir du chasseur dans le setup

        // pas valide car c'est le deuxieme tour du chasseur dans le setup
        assertNotEquals(new Coordinate(0, 0), hunter.getHunterCoord());// test si le dernier tir du chasseur
                                                                       // est en 0,0
        // pas valide car c'est le deuxieme tour du chasseur dans le setup
    }
    ...
    public void test_hunter_knowed_monster_coord() {
        ...
        ArrayList<Coordinate> real_sorted_monster_history = new ArrayList<>();// recupération de la liste des position
                                                                              ...
                                                                              // du programme
        real_sorted_monster_history.add((Coordinate) this.hunter.getKnowMonsterCoords().get(1));// premier tour du
        // monstre
    ...
    public void test_get_when_monster_was_here_for_last_time() {
        ...
        assertEquals((Integer) 1, this.hunter.getLastTurnFromCoordinate(new Coordinate(0, 0)));// test si le
                                                                                               // chasseur
        // recuperent tour 1
        ...
        // pas a celui du test
        assertNotEquals((Integer) 2, this.hunter.getLastTurnFromCoordinate(new Coordinate(0, 0)));// test si
                                                                                                  // le
                                                                                                  // chasseur
        // recuperent tour 2
        // comme information
        ...
        assertNotEquals((Integer) 2, this.hunter.getLastTurnFromCoordinate(new Coordinate(1, 0)));//// test
                                                                                                  //// si
                                                                                                  //// le
        //// chasseur
        //// recuperent tour 2
