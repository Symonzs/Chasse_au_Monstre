...
public class TestHunter {
    ...
    public void test_get_when_monster_was_here_for_last_time() {
        ...
        assertEquals((Integer) 1, this.hunter.getLastTurnFromCoordinate(new Coordinate(0, 0)));// test si le chasseur
                                                                                               // recuperent tour 1
        ...
        // pas a celui du test
        assertNotEquals((Integer) 2, this.hunter.getLastTurnFromCoordinate(new Coordinate(0, 0)));// test si le chasseur
                                                                                                  // recuperent tour 2
                                                                                                  // comme information
                                                                                                  // sur la case 0,0
        // pas valide car le chasseur connait cette position mais le tour ne correspond
        ...
        assertNotEquals((Integer) 2, this.hunter.getLastTurnFromCoordinate(new Coordinate(1, 0)));//// test si le
                                                                                                  //// chasseur
                                                                                                  //// recuperent tour 2
                                                                                                  //// comme information
                                                                                                  //// sur la case 0,0
